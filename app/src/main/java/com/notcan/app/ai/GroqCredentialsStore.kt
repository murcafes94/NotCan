...
/** Stores the user's Groq API key encrypted with an Android Keystore-backed AES key. */
class GroqCredentialsStore(context: Context) {
    ...
    companion object {
        private const val PREFS_NAME = "notcan_groq_secure"
        private const val KEY_CIPHERTEXT = "api_key_ciphertext"
        private const val KEY_IV = "api_key_iv"
        private const val KEY_ALIAS = "notcan_groq_api_key"
